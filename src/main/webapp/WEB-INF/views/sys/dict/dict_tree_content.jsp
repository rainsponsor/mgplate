...
<body>
	<div id="main_wrap">
		<div id="main_nav">
	    	<iframe name="fr_tree_content" id="fr_tree_content" frameborder="0" scrolling="yes" src="${ctx}/sys/dict/tree" allowtrancparency="true"></iframe>
	    	<div class="width_line" onmousedown="moveWidth($('#main_nav'));"></div>	
	    </div>
	    <div id="main_content">
	    	<iframe class="tree_info_content" name="tree_info_content" id="tree_info_content" frameborder="0" scrolling="yes" src="${ctx}/sys/dict/content?id=${id}"></iframe>   
	    </div> 
	</div>
</body>
</html>
