...
<body>
	<div id="main_wrap">
		<div id="main_nav">
	    	<iframe name="fr_tree_content" id="fr_tree_content" style="border-left:1px solid #ccc; border-right:1px solid #ccc; background:#f9f9f9;width: 191px;" frameborder="0" scrolling="yes" src="${ctx}/curr/know/tree?id=${id}" allowtrancparency="true"></iframe>
	    	<div class="width_line" onmousedown="moveWidth($('#main_nav'));"></div>
	    </div>
	    <div id="main_content">
	    	<iframe class="tree_info_content" name="tree_info_content" id="tree_info_content" frameborder="0" scrolling="yes" src="${ctx}/curr/know/content?id=${id}"></iframe>   
	    </div> 
	</div>
</body>
</html>
